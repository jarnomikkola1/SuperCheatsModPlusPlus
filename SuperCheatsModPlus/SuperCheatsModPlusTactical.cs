...
namespace SuperCheatsModPlus
{
	...
	public class SuperCheatsModPlusTacInstanceData
	{
	...
	/// </summary>
	public class SuperCheatsModPlusTactical : ModTactical
	{
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			SuperCheatsModPlusTacInstanceData data = (SuperCheatsModPlusTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new SuperCheatsModPlusTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
